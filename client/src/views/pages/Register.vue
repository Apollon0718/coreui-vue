            ...
            <b-card-body class="p-4">
              <b-form v-on:submit.prevent="addUser">
                ...
                <b-input-group class="mb-3">
                  ...
                  <b-form-input type="text" class="form-control" placeholder="Firstname" autocomplete="firstname" v-model="user.firstname" required/>
                </b-input-group>
                ...
                <b-input-group class="mb-3">
                  ...
                  <b-form-input type="text" class="form-control" placeholder="Lastname" autocomplete="lastname" v-model="user.lastname" required/>
                </b-input-group>
                ...
                <b-input-group class="mb-3">
                  ...
                  <b-form-input type="text" class="form-control" placeholder="Phone" autocomplete="phone" v-model="user.phone" required/>
                </b-input-group>
                ...
                <b-input-group class="mb-4">
                  ...
                  <b-form-input type="password" class="form-control" placeholder="password" v-model="user.password" autocomplete="password" />
                </b-input-group>
